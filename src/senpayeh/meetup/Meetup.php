...
use senpayeh\meetup\setups\MeetupSetup;
...
class Meetup extends PluginBase {
    ...
    public function registerManagers() : void{
        self::setMeetupSetup(new MeetupSetup(($this)));
     ...
     * @return MeetupSetup
     */
    public static function getMeetupSetup() : MeetupSetup{
        return self::$meetupsetup;
    }

    /**
     * @param MeetupSetup $meetupsetup
     */
    public static function setMeetupSetup(MeetupSetup $meetupsetup) : void{
        self::$meetupsetup = $meetupsetup;
    }
